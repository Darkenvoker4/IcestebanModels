Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/4294440d527e3564d8eb28de87195eec"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_TEXTURERAMP 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + float(-0.9));
			}
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.5149285,0.8656773,0.957614,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.5149285,0.8656773,0.957614,1).a;
