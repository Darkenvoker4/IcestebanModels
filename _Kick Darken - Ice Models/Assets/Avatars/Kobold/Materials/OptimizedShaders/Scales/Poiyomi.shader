Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/975be81e0b33ca9469720c78f1086689"
{
	Properties
	{
...
#define PROP_MOCHIEREFLECTIONSTRENGTH 0.44
#define PROP_MOCHIESPECULARSTRENGTH 1
#define PROP_MOCHIEMETALLICMULTIPLIER 0
#define PROP_MOCHIEROUGHNESSMULTIPLIER 0.48
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if (float(0.44) > 0)
				{
					...
					float reflStr = reflectionMask * float(0.44);
