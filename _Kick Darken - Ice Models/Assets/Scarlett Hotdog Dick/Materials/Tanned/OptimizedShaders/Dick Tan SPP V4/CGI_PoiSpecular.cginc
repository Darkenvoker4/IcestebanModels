...
float3 calculateSpecular(in float4 albedo)
{
    ...
    if ((0.0 /*_SpecularMaxBrightness*/))
    {
        ...
        if ((3.0 /*_LightingMode*/) == 0 && (0.0 /*_LightingRampType*/) == 1)
        {
    ...
    if ((1.0 /*_SpecularType*/) == 1) // Realistic
    {
        ...
        finalSpecular += calculateNewSpecular(specularMap.rgb, (1.0 /*_SmoothnessFrom*/), realisticAlbedo, float4(1,1,1,1), metallic, _SpecularSmoothness * specularMap.a, poiLight.dotNH, poiLight.dotLH, specularLightColor, attenuation);
    }
    ...
    if ((1.0 /*_SpecularType*/) == 4)
    {
        ...
        if ((1.0 /*_SpecularType*/) == 3) // anisotropic
        {
            ...
            jitter += (0.0 /*_Spec1Offset*/);
            float4 packedTangentMap = POI2D_SAMPLER_PAN(_AnisoTangentMap, _MainTex, poiMesh.uv[(0.0 /*_AnisoTangentMapUV*/)], float4(0,0,0,0));
            finalSpecular += AnisotropicSpecular((0.0 /*_SpecWhatTangent*/), (0.0 /*_AnisoUseTangentMap*/), _SpecularSmoothness, (0.0 /*_Spec2Smoothness*/), (1.0 /*_AnisoSpec1Alpha*/), (1.0 /*_AnisoSpec2Alpha*/), float4(1,1,1,1), metallic, specularMap, specularLightColor, poiLight.direction, poiLight.halfDir, poiLight.nDotL, jitter, packedTangentMap, albedo);
            finalSpecular *= float4(1,1,1,1);
            finalSpecular *= attenuation;
        }
    #endif
        ...
        for (int index = 0; index < 4; index++)
        {
            ...
            if ((1.0 /*_SpecularType*/) == 1) // Realistic
            {
                finalSpecular += calculateNewSpecular(specularMap.rgb, (1.0 /*_SmoothnessFrom*/), realisticAlbedo, float4(1,1,1,1), metallic, _SpecularSmoothness * specularMap.a, poiLight.vDotNH[index], poiLight.vDotLH[index], poiLight.vColor[index], poiLight.vAttenuationDotNL[index]);
            }
        }
    #endif
