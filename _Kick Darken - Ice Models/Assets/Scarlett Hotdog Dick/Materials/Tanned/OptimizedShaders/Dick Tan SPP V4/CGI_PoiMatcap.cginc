    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        half2 matcapUV = half2(dot(worldViewRight, poiMesh.normals[(1.0 /*_MatcapNormal*/)]), dot(worldViewUp, poiMesh.normals[(1.0 /*_MatcapNormal*/)])) * (0.295 /*_MatcapBorder*/) + 0.5;
        #if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
        ...
        blendMatcap(finalColor, (0.244 /*_MatcapAdd*/), (0.258 /*_MatcapMultiply*/), (0.08 /*_MatcapReplace*/), matcap, matcapMask, matcapEmission, (0.0 /*_MatcapEmissionStrength*/)
        #ifdef POI_LIGHTING
